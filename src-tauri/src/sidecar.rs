...
/// The wrapper patch overlay written at every launch: a single bare-name row
/// for the `dsh-desktop` package staged into `resources/dsh/node_modules`,
...
mod tests {
    ...
    #[test]
    fn overlay_patch_carries_the_wrapper_row() {
